        ...
        <div class="card-body p-3">
                <img src="<?= base_url('assets/img/logo-mayasi.png'); ?>" align="left" width="165">
                            <div class="text-center ">
                                <h1 class="h1 text-gray-900 mb-2 mr-5 mt-4">CERITA COFFE</h1>
                                <h4 class="h4 text-gray-900 mb-2 mr-5 mt-2">Jl. 28 oktober Pontianak Utara</h4>
                                <h6 class="h5 text-gray-900 mr-5">No handphone : 085656789099 Email :ceritacofee556@gmail.com </h6>
                                <hr class="border border-dark border-2 opacity-50">
                         
<h2 align="center" class="text-gray-900"><strong><?= $title; ?> </strong></h2> 
<h5 class=" text-gray-900 float-left ml-5">Periode :<?= $bulan; ?>/<?= $tahun; ?></h5>
</div>
